...
public class InventoryShieldingBullet extends InventoryExoticPotionBullet {
	...
	@Override
	public Potion getPotion() { return new PotionOfShielding(); }
	...
	public static class Bullet extends ArcaneFirearm.Bullet {
		{
			...
			maxFactor = 2.75f;
			parentClass = InventoryShieldingBullet.class;
		}

		@Override
		public InventoryBullet get_inventory_bullet() { return new InventoryShieldingBullet(); }

		@Override
		public int proc(Char attacker, Char defender, int damage)  {
			int dmg = super.proc(attacker, defender, damage);

			Buff.affect(attacker, Barrier.class).setShield(Math.round(1.5f*dmg));
	...
	public static class Craft extends ToolboxRecipe {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
            return ingredients.size() == 1 && ingredients.get(0).getClass().equals(PotionOfShielding.class);
        }
		...
		public Item craft(ArrayList<Item> ingredients) {
			...
			InventoryShieldingBullet bullets = new InventoryShieldingBullet();
			bullets.quantity(5);
			return bullets;
		}
