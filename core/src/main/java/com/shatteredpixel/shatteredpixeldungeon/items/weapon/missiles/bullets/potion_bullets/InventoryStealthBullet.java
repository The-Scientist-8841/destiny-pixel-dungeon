...
public class InventoryStealthBullet extends InventoryPotionBullet {
	...
	@Override
	public Potion getPotion() { return new PotionOfInvisibility(); }
		...
		public void onHit(Char attacker, Char defender) {
			if (defender != null) {
				if (attacker instanceof Hero) {
					PotionOfInvisibility p = new PotionOfInvisibility();
					p.identify(true);
				}
			}
		}
	...
	public static class Craft extends ToolboxRecipe {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
            return ingredients.size() == 1 && ingredients.get(0).getClass().equals(PotionOfInvisibility.class);
        }
