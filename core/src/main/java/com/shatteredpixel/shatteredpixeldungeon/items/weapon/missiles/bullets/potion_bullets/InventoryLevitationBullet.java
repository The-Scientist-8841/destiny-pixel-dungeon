...
public class InventoryLevitationBullet extends InventoryPotionBullet {
	...
	@Override
	public Potion getPotion() { return new PotionOfLevitation(); }
	...
	public static class Bullet extends ArcaneFirearm.Bullet {
		{
			...
			maxFactor = 2.5f;
			parentClass = InventoryLevitationBullet.class;
		}

		@Override
		public InventoryBullet get_inventory_bullet() {
			return new InventoryLevitationBullet();
		}

		@Override
		public void onHit(Char attacker, Char defender) {
			if (defender != null && !defender.isImmune(Floating.class)) {
				Buff.affect(defender, Floating.class, 3f);

				if (attacker instanceof Hero) {
					PotionOfLevitation p = new PotionOfLevitation();
					p.identify(true);
				}
			}
		}
	...
	public static class Craft extends ToolboxRecipe {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
            return ingredients.size() == 1 && ingredients.get(0).getClass().equals(PotionOfLevitation.class);
        }
		...
		public Item craft(ArrayList<Item> ingredients) {
			...
			InventoryLevitationBullet bullets = new InventoryLevitationBullet();
			bullets.quantity(5);
			return bullets;
		}
