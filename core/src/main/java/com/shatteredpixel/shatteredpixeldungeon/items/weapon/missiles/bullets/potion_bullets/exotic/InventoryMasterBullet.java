...
public class InventoryMasterBullet extends InventoryExoticPotionBullet {
	...
	@Override
	public Potion getPotion() { return new PotionOfMastery(); }
	...
	public static class Bullet extends ArcaneFirearm.Bullet {
		{
			...
			scalingFactorMax = 7f;
			maxFactor = 7f;
			parentClass = InventoryMasterBullet.class;
		}

		@Override
		public InventoryBullet get_inventory_bullet() { return new InventoryMasterBullet(); }
	...
	public static class Craft extends ToolboxRecipe {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
            return ingredients.size() == 1 && ingredients.get(0).getClass().equals(PotionOfMastery.class);
        }
		...
		public Item craft(ArrayList<Item> ingredients) {
			...
			InventoryMasterBullet bullets = new InventoryMasterBullet();
			bullets.quantity(5);
			return bullets;
		}
