...
public class WndBag extends WndTabbed {
	...
	public WndBag( Bag bag, ItemSelector selector ) {
		...
		nRows = (int)Math.ceil(55/(float)nCols); //we expect to lay out 55 slots in all cases
	...
	protected void placeItems( Bag container ) {
		...
		placeItem( stuff.misc2 != null ? stuff.misc2 : new Placeholder( ItemSpriteSheet.SOMETHING ) );
	...
	private Image icon( Bag bag ) {
		...
		} else if (bag instanceof AmmoBag) {
			return Icons.get(Icons.AMMO_BAG);
		}else {
