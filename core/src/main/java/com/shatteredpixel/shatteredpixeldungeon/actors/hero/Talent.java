...
public enum Talent {
	...
	//Duelist T2
	FOCUSED_MEAL(132,4), LIQUID_AGILITY(133,4), WEAPON_RECHARGING(134,4), LETHAL_HASTE(135,4), SWIFT_EQUIP(136,4), FERVENT_BLESSING(196,4),
	//Duelist T3
	...
	public static void initClassTalents( HeroClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, LinkedHashMap<Talent, Talent> replacements ){
		...
		switch (cls){
			...
			case HUNTRESS:
				...
				break;
			case DUELIST:
				Collections.addAll(tierTalents, FOCUSED_MEAL, LIQUID_AGILITY, WEAPON_RECHARGING, LETHAL_HASTE, SWIFT_EQUIP, FERVENT_BLESSING);
				break;
			case CLERIC:
