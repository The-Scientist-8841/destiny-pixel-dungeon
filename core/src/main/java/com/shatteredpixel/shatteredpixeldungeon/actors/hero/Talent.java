...
public enum Talent {
	...
	//Cleric T2
	ENLIGHTENING_MEAL(164, 4), RECALL_INSCRIPTION(165,4), SUNRAY(166,4), DIVINE_SENSE(167,4), BLESS(168,4), DIVINE_BLESSING(197,4),
	//Cleric T3
	...
	public static void initClassTalents( HeroClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, LinkedHashMap<Talent, Talent> replacements ){
		...
		switch (cls){
			...
			case DUELIST:
				...
				break;
			case CLERIC:
				Collections.addAll(tierTalents, ENLIGHTENING_MEAL, RECALL_INSCRIPTION, SUNRAY, DIVINE_SENSE, BLESS, DIVINE_BLESSING);
				break;
		}
		for (Talent talent : tierTalents){
			if (replacements.containsKey(talent)){
