...
public enum Talent {
	...
	//Cleric T1
	SATIATED_SPELLS(160,4), HOLY_INTUITION(161,4), SEARING_LIGHT(162,4), SHIELD_OF_LIGHT(163,4), CLERGYMANS_DISCOUNT(187,4),
	//Cleric T2
	...
	public static void initClassTalents( HeroClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, LinkedHashMap<Talent, Talent> replacements ){
		...
		switch (cls){
			...
			case DUELIST:
				...
				break;
			case CLERIC:
				Collections.addAll(tierTalents, SATIATED_SPELLS, HOLY_INTUITION, SEARING_LIGHT, SHIELD_OF_LIGHT, CLERGYMANS_DISCOUNT);
				break;
		}
