...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		if (landscape()) {
			...
			btnSettings.setRect(btnJournal.right()+2, btnRankings.top(), btnRankings.width(), BTN_HEIGHT);
			btnAbout.setRect(btnJournal.left(), btnSettings.bottom() + GAP, btnRankings.width(), BTN_HEIGHT);
		} /*else {
			btnPlay.setRect(btnAreaLeft, insets.top + topRegion+GAP, buttonAreaWidth, BTN_HEIGHT);
			align(btnPlay);
