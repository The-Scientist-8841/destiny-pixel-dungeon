...
public class ItemSpriteSheet {
	...
	private static final int TX_HEIGHT = 864;
	...
	public static final int ARCANE_PIECE	= MISC_CONSUMABLE +23;
	...
	static{
		...
		assignItemRect(ARCANE_PIECE,	10,	11);
	...
	public static final int SCROLL_ARTIFACT_LEVELLING = SCROLLS+12;

	public static final int ARCANE_RESIN    = SCROLLS+13;
	static {
		for (int i = SCROLLS; i < SCROLLS+13; i++)
	...
	public static final int AMMO_BAG	= BAGS+7;
	static{
	...
	public static final int MODIFICATION_HOLDER = BULLET + 4;
	static {
	...
	static {
		assignItemRect(WEAPON_LACING, 13, 13);
