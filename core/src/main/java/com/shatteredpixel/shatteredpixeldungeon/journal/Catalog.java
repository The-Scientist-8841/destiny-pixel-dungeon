...
import com.shatteredpixel.shatteredpixeldungeon.items.remains.ArcanePiece;
...
public enum Catalog {
	...
	static {
		...
		MISC_CONSUMABLES.addItems( Gold.class, EnergyCrystal.class, ArcaneMaterial.class, Dewdrop.class,
				...
				SealShard.class, BrokenStaff.class, CloakScrap.class, BowFragment.class, BrokenHilt.class, TornPage.class, ArcanePiece.class);
